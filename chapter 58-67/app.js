...
// iv 
var first_name = document.getElementById("first-name").value='batool'
// v 
var last_name = document.getElementById("last-name").value='fatima'
var email = document.getElementById("email").value='batoolfatima123@gmail.com'
